...
NSString * const GDYSDKNetworkAccessibityChangedNotification = @"GDYSDKNetworkAccessibityChangedNotification";
...
@interface GDYSDKNetworkAccessibity () {
...
@implementation GDYSDKNetworkAccessibity
...
+ (GDYSDKNetworkAccessibity *)sharedInstance {
    static GDYSDKNetworkAccessibity * instance = nil;
...
static void ReachabilityCallback(SCNetworkReachabilityRef target, SCNetworkReachabilityFlags flags, void* info) {
    GDYSDKNetworkAccessibity *networkAccessibity = (__bridge GDYSDKNetworkAccessibity *)info;
    if (![networkAccessibity isKindOfClass: [GDYSDKNetworkAccessibity class]]) {
        return;
    }
...
- (void)notiWithAccessibleState:(NetworkAccessibleState)state {
    ...
    if (state != _previousState) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:GDYSDKNetworkAccessibityChangedNotification object:nil];
